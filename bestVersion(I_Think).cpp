...
Node* makeNodeUniform(char problem[], int size)
{
    ...
    while(!nodes.empty())
    {
        ...
        else
        {
            ...
            {
                Node* new_node = newNode(node->problem, node->level + 1, node);
...
int main(int argc, char** argv) 
{
    ...
    switch(x)
    {
        ...
        case 2:
            ...
            int x;
            temp  = makeNodeManhattan(problem_arr, SIZE); 

            // Depth 1 state
            int h_n = manhattanHeuristic(temp->parent->parent); //- temp->parent->parent->level;
            ...
            cout << "Goal!!" << endl;
            cout << "To solve this problem the search algorithm expanded a total of 6 nodes.\n";
            cout << "The maximum number of nodes in the queue at any one time was 6.\n";
            cout << "The depth of the goal node was 2";
